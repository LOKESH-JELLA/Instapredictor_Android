 ...
 * {@link Panchangamfragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Panchangamfragment#newInstance} factory method to
...
public class Panchangamfragment extends Fragment {
     ...
     * @return A new instance of fragment Panchangamfragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Panchangamfragment newInstance(String param1, String param2) {
...
editor.commit();*/
        ...
        if(chartid.equals("") && bhavaMadhyaid.equals("") && ayanmshaid.equals("")&& langid.equals("") && nodeid.equals("")) {
            ...
            if (!latitude.equals("0.0") && !longitude.equals("0.0") && !latitude.equals("") && !longitude.equals("")) {
                ...
                mywebview.loadUrl("https://astrouser.com/astroapp/mobileapp/panchangam.aspx?" + queryurl1);
            } else {
                pb.setVisibility(View.GONE);
            }
        }
        else {
            mywebview.loadUrl("https://astrouser.com/astroapp/mobileapp/panchangam.aspx?" + queryurl);

        }
        Log.e("url", "https://kpaf.in/astroapp/mobileapp/panchangam.aspx?lat=" + String.valueOf(latitude) + "&Lon=" + String.valueOf(longitude) + "&tz=" + String.valueOf(tz) + "&Mydate=" + date + "&charttype=N");
