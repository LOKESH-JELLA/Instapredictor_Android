 ...
 * {@link LagnaFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link LagnaFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LagnaFragment extends Fragment {
...
ProgressDialog pd;
     ...
     * @return A new instance of fragment LagnaFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static LagnaFragment newInstance(String param1, String param2) {
        LagnaFragment fragment = new LagnaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_lagna, container, false);
...
*/
        ...
        if(chartid.equals("") && bhavaMadhyaid.equals("") && ayanmshaid.equals("")&& langid.equals("") && nodeid.equals("")) {
            if (!latitude.equals("0.0") && !longitude.equals("0.0") && !latitude.equals("") && !longitude.equals("")) {
                //mywebview.loadUrl("https://kpaf.in/astroapp/mobileapp/lagna.aspx?lat=" + String.valueOf(latitude) + "&Lon=" + String.valueOf(longitude) + "&tz=" + String.valueOf(tz) + "&Mydate=" + date + "&charttype=N");
                mywebview.loadUrl("https://astrouser.com/astroapp/mobileapp/lagna.aspx?" + queryurl1);
                Log.e("url", "https://astrouser.com/astroapp/mobileapp/lagna.aspx?lat=" + String.valueOf(latitude) + "&Lon=" + String.valueOf(longitude) + "&tz=" + String.valueOf(tz) + "&Mydate=" + date + "&charttype=N" + "&Placename=" + Placename + "&Nodetype=" + GlobalDeclaration.node);
            ...
            mywebview.loadUrl("https://astrouser.com/astroapp/mobileapp/lagna.aspx?" + queryurl);
